...
function preload() {
  ...
  back = loadImage("gameoverimage.jpg");
...
if (gamestate=="start") {
  textSize(20);
  textFont("Arial");
  text("Controles",100,100);
  text("* Adelante = Flecha derecha*",100,200);
  text("* Atrás = Flecha izquierda*",100,250);
  text("* Saltar = Flecha arriba*",100,300);
  text("* Disparar bola de fuego = S*",100,350);
  text("Para continuar presiona espacio",100,450);
  mario.visible=false;
